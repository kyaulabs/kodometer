...
class CodexProviderAdapter final : public ProviderAdapter
{
    Q_OBJECT
  ...
  public:
    ...
    explicit CodexProviderAdapter(QNetworkAccessManager *network = nullptr,
  ...
  private:
    ...
    CodexCredentials m_credentials;
